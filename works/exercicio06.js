function main() {
    ...
    // Red cylinder
    var cylinderGeometry2 = new THREE.CylinderGeometry(0.1, 0.1, 1.2, 25);
    ...
    // yellow cylinders
    var cylinderGeometry3 = new THREE.TorusBufferGeometry(0.2, 0.15, 16, 50);
    ...
    var cylinderGeometry4 = new THREE.TorusBufferGeometry(0.2, 0.15, 16, 50);
    var cylinderMaterial4 = new THREE.MeshPhongMaterial({ color: 'rgb(255,255,250)' });
    ...
    function rotateCylinder() {
        ...
        if (animationOn) {
            ...
            // Will execute R3, T1 and R1 in this order
            ...
            cylinder4.matrix.multiply(mat4.makeRotationY(angle4));
